...
namespace Mictlanix.BE.Web.Models {
	public static class MBEQueryable {
		...
		public static IQueryable<Customer> IQCustomers { get { return Customer.Queryable.Where (x => !x.IsDeleted).OrderByDescending(x => x.Id); } }
		...
		public static IQueryable<Vehicle> IQVehicles { get { return Vehicle.Queryable.Where(x => x.IsActive); } }
		public static IQueryable<VehicleOperator> IQVehicleOperators { get { return VehicleOperator.Queryable.Where(x => !x.Operator.IsDisabled); } }
		...
		public static IQueryable<UserSettings> IQUsersSettings { get { return UserSettings.Queryable; } }
