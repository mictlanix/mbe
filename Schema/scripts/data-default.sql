...
INSERT INTO customer (customer_id, code, name, credit_limit, credit_days, price_list, shipping, shipping_required_document)
VALUES (1,'PG','Público en General',0,0,1,0,0);
